...
**Версия:** 0.7.1 · **Платформа:** Windows (portable .exe) · **Модели:** LM Studio (локально)
...
- Поддержка **PDF, DJVU, EPUB, FB2, DOCX, TXT, HTML, ZIP/RAR/7z**
...
1. Скачайте `Bibliary 0.7.1.exe` из [Releases](https://github.com/antsincgame/bibliary/releases)
...
4. Запустите `Bibliary 0.7.1.exe` — данные хранятся рядом с exe
...
- **Watchdog** — убивает зависшие child-процессы (ddjvu/calibre/tesseract) по таймауту

...
**Версия:** 0.10.0 · **Платформа:** Windows (portable .exe) · **Модели:** LM Studio (локально)
...
1. Скачайте `Bibliary 0.10.0.exe` из [Releases](https://github.com/antsincgame/bibliary/releases)
...
4. Запустите `Bibliary 0.10.0.exe` — данные хранятся рядом с exe

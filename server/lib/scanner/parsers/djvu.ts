...
import { imageBufferToPng } from "../_vendor/native/sharp-loader.js";
import { pickBestBookTitle } from "../_vendor/library/title-heuristics.js";
...
async function hasVisionOcrModel(preferredKey?: string): Promise<boolean> {
  try {
    ...
    const { getVisionOcrModel } = await import("../_vendor/llm/model-resolver.js");

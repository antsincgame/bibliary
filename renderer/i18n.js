...
const DICT = /** @type {Record<Locale, Record<string,string>>} */ ({
  ru: {
    ...
    "library.preview.ocr.body": "Из такого файла нельзя извлечь текст без OCR. Phase 6.0 (OCR-модуль) добавит распознавание изображений в дорожной карте — пока книга добавится только как метаданные.",
  ...
  en: {
    ...
    "library.preview.ocr.body": "Text cannot be extracted without OCR. Phase 6.0 (OCR module) will add image recognition — for now the book will be ingested with metadata only.",
